<template>
  <div>
    <div class="container">
      <div class="alert bg-dark text-white shadow">Add Product</div>
      <div class="row">
        <div class="col-lg-12">
          <div class="wrap shadow rounded p-3">
            <form enctype="maltipart/form-data" @submit.prevent="addProduct">
              <div class="row">
                <div class="col-lg-6">
    ...
    addProduct() {
      axios
        ...
        .then((response) => {
          ...
          Sweet.notification("success", "Product Inserted !");
        })
        .catch((error) => {
