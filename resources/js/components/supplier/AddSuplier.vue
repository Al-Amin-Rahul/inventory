  ...
  <div>
    <div class="container">
      <div class="alert bg-dark text-white shadow">
        <i class="fas fa-users"></i> Add Suplier
      </div>
      <div class="row">
        <div class="col-lg-12">
          <div class="wrap shadow rounded p-3">
            <form enctype="maltipart/form-data" @submit.prevent="addSuplier">
              <div class="row">
                <div class="col-lg-6">
...
export default {
  ...
  methods: {
    addSuplier() {
      axios
        .post("/api/suplier", this.form)
        .then((response) => {
          this.$router.push({ name: "suplier" });
          Sweet.notification("success", "Suplier Inserted !");
        })
        .catch((error) => {
