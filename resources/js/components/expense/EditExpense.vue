  ...
  <div>
    <div class="container">
      <div class="alert bg-dark text-white shadow">
        <i class="fas fa-users"></i> Edit Expense
      </div>
      <div class="row">
        <div class="col-lg-12">
          <div class="wrap shadow rounded p-3">
            <form enctype="maltipart/form-data" @submit.prevent="updateExpense">
              <div class="row">
                <div class="col-lg-6">
...
export default {
  ...
  methods: {
    updateExpense() {
      ...
      axios
        .put("/api/expense/" + id, this.form)
        .then((response) => {
          this.$router.push({ name: "expense" });
          Sweet.notification("success", "Expense Updated !");
        })
        .catch();
    },
  },
